...
namespace SmkcApi.Services
{
    ...
    public class SmsService : ISmsService
    {
        ...
        private const string Template = "सा. मि. कु. मनापा. आपले पाणी जोडणी क्रमांक {CONN} थकबाकी सहित रक्कम रुपये {AMT}. चे बिल तयार झाले आहे. 31 ऑक्टोबर 2025 पर्यंत एकूण रूपये {AFTER} संपूर्ण भरल्यास अभय योजनेअंतर्गत रुपये {DISC} ची सवलत मिळेल";
        ...
        private string NormalizeMobile(string raw)
        {
            ...
            if (s.Length == 13 && s.StartsWith("+91")) return s.Substring(1);
            // else return as-is
            return s;
        }
    }
